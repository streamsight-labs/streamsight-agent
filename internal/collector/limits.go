...
// echoes a limits block. The two error caps are excluded because both always
// have a non-zero default, which would make any() unconditionally true and
// contradict Batch.Limits' "nil when every cap is unlimited".
